...
function module_flush(params){
    ...
    remote['get']("/_admin/modules/flush").then(function(res){
        console.log(res);
    },function(err){
...
function module_upload(params,args){
    ...
    remote.use("_modules").simple.first({path:params.path}).then(function(res) {
            /* update module */
            return remote.document.put(res.document._id,_module);
        }, function(err) {
            /* create module */
            return remote.document.create(_module);
        }).then(function(res){
